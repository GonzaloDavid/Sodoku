...
public class Interface extends javax.swing.JFrame {
    ...
    public void imprimirCronometro() {
        ...
        for (minutos = 0; segundos < 60; segundos++) {
            ...
            TAtiempo.setText("Minutos :"+String.valueOf(minutos)+" Seconds :"+String.valueOf(segundos));
            TAtiempo1.setText("Minutos :"+String.valueOf(minutos)+" Seconds :"+String.valueOf(segundos));
...
public void colocar9()
{
    ...
    public boolean ValidarValor4(int valor) {
     ...
     public boolean ValidarValor9(int valor) {
    ...
    public boolean ValidarFila(int valor, int fila, int Matizllega[][], int columna) {

        boolean resultado = false;

        for (int j = 0; j < Matizllega.length; j++) {
            if (Matizllega[(fila)][j] == valor && fila != j && j != columna) {

                resultado = true;
                // System.out.println(valor +"de la fila"+fila+"compara"+Matizllega[(fila)][j] );
                JOptionPane.showMessageDialog(null, "No se puede repetir un numero en la misma fila\ncambie el numero :" + valor + " ubicado en \nLa fila :" + (fila + 1) + "\nY la columna :" + (columna + 1));
    ...
    public boolean ValidarColumna(int valor, int columna, int Matizllegada[][], int fila) {

        boolean resultado = false;
        for (int i = 0; i < Matizllegada.length; i++) {
            if (Matizllegada[i][(columna)] == valor && columna != i && i != fila) {
                resultado = true;
                JOptionPane.showMessageDialog(null, "No se puede repetir un numero en la misma Columna\ncambie el numero :" + valor + " ubicado en \nLa fila :" + (fila + 1) + "\nY la columna :" + (columna + 1));
     ...
     public boolean ValidarCaja4(int valorMatriz, int F, int C, int[][] vector4) {
        boolean aux = false;
        int minifila, maxFila;
        int minColumna,maxColumna;
        minifila=0;
        minColumna=0;
        maxColumna=0;
        maxFila=0;
        ...
        for (int filaAux = minifila; filaAux <= maxFila; filaAux++) {
            for (int ColumnaAux = minColumna; ColumnaAux <= maxColumna; ColumnaAux++) {
                if (vector4[filaAux][ColumnaAux] == valorMatriz) {
                    aux = true;
                    break;
    ...
    public boolean ValidarCaja9(int valorMatriz, int F, int C, int[][] vector9) {
        boolean aux = false;
        int minifila, maxFila;
        int minColumna,maxColumna;
        minifila=0;
        ...
        for (int filaAux = minifila; filaAux <= maxFila; filaAux++) {
            for (int ColumnaAux = minColumna; ColumnaAux <= maxColumna; ColumnaAux++) {
                if (vector9[filaAux][ColumnaAux] == valorMatriz) {
                    aux = true;
                    break;
    ...
    public void llenarIntro()
{
txaIntro9.setText("INSTRUCCION:\n\nEl Sudoku es un rompecabezas de lógica y uno de \n los pasatiempos que más engancha.\n"
        + "\nEl objetivo es rellenar una cuadrícula de 9×9 celdas \ndividida en subcuadrículas de 3×3 con las cifras del \n"
        + "1 al 4 ubicandolas en algunas de las celdas.\n\nNo se debe repetir ningún número en una misma \nfila, columna o subcuadrícula.");
txaIntro.setText("INSTRUCCION:\n\nEl Sudoku es un rompecabezas de lógica y uno de \n los pasatiempos que más engancha.\n"
        + "\nEl objetivo es rellenar una cuadrícula de 4×4 celdas \n\ndividida en subcuadrículas de 2×2 con las cifras del \n"
        + "1 al 9 ubicandolas en algunas de las celdas.\nNo se debe repetir ningún número en una misma \nfila, columna o subcuadrícula.");
    ...
    private void initComponents() {
        ...
        Terminar4 = new javax.swing.JButton();
        jScrollPane12 = new javax.swing.JScrollPane();
        txaIntro9 = new javax.swing.JTextArea();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(47, 47, 47)
                        .addComponent(jLabel87, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        Terminar4.setText("TERMINAR");
        Terminar4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Terminar4ActionPerformed(evt);
            }
        });

        txaIntro9.setColumns(20);
        txaIntro9.setRows(5);
        jScrollPane12.setViewportView(txaIntro9);

        jLabel92.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel92.setText("APRENDIENDO BACKTRAKING CON SUDOKU");

        jButton6.setText("REINICIAR CON AYUDA");
        ...
        IngresoSudoLayout.setHorizontalGroup(
            ...
            .addGroup(IngresoSudoLayout.createSequentialGroup()
                ...
                .addGroup(IngresoSudoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(IngresoSudoLayout.createSequentialGroup()
                        .addGap(155, 155, 155)
                        .addComponent(Terminar4, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(178, Short.MAX_VALUE))
            .addGroup(IngresoSudoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, IngresoSudoLayout.createSequentialGroup()
                    .addContainerGap(221, Short.MAX_VALUE)
                    .addComponent(jLabel92, javax.swing.GroupLayout.PREFERRED_SIZE, 549, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(210, 210, 210)))
        );
        IngresoSudoLayout.setVerticalGroup(
            ...
            .addGroup(IngresoSudoLayout.createSequentialGroup()
                .addGap(84, 84, 84)
                .addGroup(IngresoSudoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(IngresoSudoLayout.createSequentialGroup()
                    ...
                    .addGroup(IngresoSudoLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(Terminar4, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, 0)
                                .addComponent(jScrollPane105, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel6Layout.createSequentialGroup()
        ...
        jLabel93.setText("CANDIDATOS");

        jLabel94.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel94.setText("CANDIDATOS");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(184, 184, 184)
                        .addComponent(jLabel94, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel5Layout.createSequentialGroup()
                    .addGap(327, 327, 327)
        ...
        txaIntro.setRows(5);
        jScrollPane11.setViewportView(txaIntro);

        jButton9.setText("COLOCAR AYUDA");
                ...
                .addGroup(IngresoSudo9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(IngresoSudo9Layout.createSequentialGroup()
                        .addGroup(IngresoSudo9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jScrollPane11, javax.swing.GroupLayout.PREFERRED_SIZE, 302, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        for (int i = 0; i < vector9.length; i++) {
            for (int j = 0; j < vector9.length; j++) {
                ValidarValor9(vector9[i][j]);
            }
        }
        for (int i = 0; i < vector9.length; i++) {
            for (int j = 0; j < vector9.length; j++) {

                ValidarFila(vector9[i][j], i, vector9, j);
        ...
        for (int i = 0; i < vector9.length; i++) {
            for (int j = 0; j < vector9.length; j++) {
                ...
                ValidarColumna(vector9[i][j], j, vector9, i);
            }
        }
        for (int i = 0; i < vector9.length; i++) {
            for (int j = 0; j < vector9.length; j++) {

                ValidarCaja9(vector9[i][j], i, j, vector9) ;
        ...
        for (int i = 0; i < vector9.length; i++) {
            for (int j = 0; j < vector9.length; j++) {
                ...
                if(ValidarFila(vector9[i][j], i, vector9, j)==false&&ValidarColumna(vector9[i][j], j, vector9, i)==false&&ValidarCaja9(vector9[i][j], i, j, vector9)==false&&ValidarValor9(vector9[i][j])==true)
                {
    ...
    private void Terminar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Terminar4ActionPerformed
        llenarMatriz4();
        llenarMatrizSudoku4();
        imprimir4();
        for (int i = 0; i < vector4.length; i++) {
            for (int j = 0; j < vector4.length; j++) {
                ValidarValor4(vector4[i][j]);
            }
        }
        for (int i = 0; i < vector4.length; i++) {
            for (int j = 0; j < vector4.length; j++) {

                ValidarFila(vector4[i][j], i, vector4, j);
        ...
        for (int i = 0; i < vector4.length; i++) {
            for (int j = 0; j < vector4.length; j++) {
                ...
                ValidarColumna(vector4[i][j], j, vector4, i);
            }
        }
        for (int i = 0; i < vector4.length; i++) {
            for (int j = 0; j < vector4.length; j++) {

                ValidarCaja4(vector4[i][j], i, j, vector4) ;
        ...
        for (int i = 0; i < vector4.length; i++) {
            for (int j = 0; j < vector4.length; j++) {
                ...
                if(ValidarFila(vector4[i][j], i, vector4, j)==false&&ValidarColumna(vector4[i][j], j, vector4, i)==false&&ValidarCaja4(vector4[i][j], i, j, vector4)==false&&ValidarValor4(vector4[i][j])==true)
                {
                   salida="JUEGO TERMINADO";
    ...
    }//GEN-LAST:event_Terminar4ActionPerformed
    ...
    private javax.swing.JButton Terminar4;
    ...
    private javax.swing.JTextArea txaIntro9;
